...
python main.py --ni --config gopro_blur_gamma_256_deblur.yml --datatype "blur" --gopro_H --exp /tmp2/ICML2025/GoPro --doc gopro --deg deblur_arbitral -i deblur_gopro --steps 5 --outfile ./exp/gorpo_blur_result_5_original.txt 
